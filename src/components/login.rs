    ...
    html! {
       <body class="login-page">
        <div class="flex w-screen">
                ...
                <h1 class="text-3xl text-white my-8">{"Ngobrol Banh!"}</h1>
                    <form class="m-4 flex">
                        <input {oninput} class="rounded-l-lg p-4 border-t mr-0 border-b border-l text-gray-800 border-gray-200 bg-white" placeholder="User" />
